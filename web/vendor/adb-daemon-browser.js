...
// server-only features like devicetracker_proto_format/server_status/
// track_mdns are NOT sent to the device).
const CNXN_FEATURES = 'shell_v2,cmd,stat_v2,ls_v2,fixed_push_mkdir,apex,abb,fixed_push_symlink_timestamp,abb_exec,remount_shell,track_app,sendrecv_v2,sendrecv_v2_brotli,sendrecv_v2_lz4,sendrecv_v2_zstd,sendrecv_v2_dry_run_send,devraw,app_info,delayed_ack';
